<template>
    <div class="asamiyoga-assay-page">
        <div class="asamiyoga-assay-header" >
            ...
            <div class="mamiyoga-assay-content"  :class="showContentOrNot"  >
                ...
                <div style="padding-top:5h;">
                    <div class="mamiyoga-assay-share-box">
                        <div class="asamiyoga-assay-grade-box">
                            <p>准确率</p>
                            <div class="asamiyoga-assay-grade-num">
                                <h3>76</h3>
                                <p>%</p>
                            </div>
                        </div>
                        <p style="margin-top:5vh;margin-bottom:0;">快和朋友们分享这次的练习成果吧！</p>
                        <div class="asamiyoga-assay-share-icon-box">
                            <div class="mamiyoga-assay-share-icon">
                                <img src="/asamiyoga/share-icon-facebook.svg" alt="">
                                <!-- <p>Facebook</p> -->
                            </div>
                            <div class="mamiyoga-assay-share-icon">
                                <img src="/asamiyoga/share-icon-chat.svg" alt="">
                                <!-- <p>messenger</p> -->
                            </div>
                            <div class="mamiyoga-assay-share-icon">
                                <img src="/asamiyoga/share-icon-twitter.svg" alt="">
                                <!-- <p>Twitter</p> -->
                            </div>
                            <div class="mamiyoga-assay-share-icon">
                                <img src="/asamiyoga/share-icon-wechat.svg" alt="">
                                <!-- <p>WeChat</p> -->
                            </div>
                            <div class="mamiyoga-assay-share-icon">
                                <img src="/asamiyoga/share-icon-more.svg" alt="">
                            </div>
                        </div>
                        <div class="asamiyoga-assay-contact-box" id="contact-us-box">
                        <p>分析结果不如预期吗？</p>
                ...
                <div class="asamiyoga-assay-contact-back" v-if="show_contact_box">
                ...
                <div class="asamiyoga-assay-contact-back" v-if="show_star_box && show">
                    <div class="mamiyoga-assay-contact-open">
                        <div class="cancel-box" @click="show_star_box = false">
                            <img src="/asamiyoga/cancel.svg" alt="">
                        </div>
                        <p>请问您满意这次的分析结果吗？</p>
                        <img src="/asamiyoga/star-box-human.svg" alt="">
                        <div class="star-line-box">
...
@media (max-width: 899px) {
    ...
    .asamiyoga-assay-grade-box {
        width:75vw;
        margin:10px auto 0;
    }
    .asamiyoga-assay-grade-num {
        display: flex;
        justify-content: center;
        align-items: baseline;
    }
    .asamiyoga-assay-grade-num h3 {
        font-size:100px;
        color:#97A8Af;
        text-align:center;
        font-weight:400;
    ...
    .asamiyoga-assay-share-icon-box {
        /* background: green; */
        width: 80vw;
        height: 10vh;
        display: flex;
    ...
    .asamiyoga-assay-contact-box {
        width: 60vw;
        height: 20vh;
        /* background: red; */
        margin: 15px auto 0 ;
    }
    .asamiyoga-assay-contact-box p {
        font-size: 12px;
        color:black;
        text-align: center;
        margin-bottom:10px; 
    ...
    .select-star label {
        ...
        /* background: red; */
        margin: 0 4px ;
        background-image: url('/asamiyoga/star.svg') ;
        background-repeat: no-repeat;
        background-size: 75%; 
    }
    ...
    .stars.five:checked ~ .select-star .first-star {
        background-image: url('/asamiyoga/star-checked.svg');
    }
    ...
    .select-questions .first-questions {
        background-image: url('/asamiyoga/babyface-icon/babyface-icon-01.svg');
    }
    .questions.first:checked ~ .select-questions .first-questions {
        background-image: url('/asamiyoga/babyface-icon/babyface-icon-checked-01.svg');
    }
    .select-questions .second-questions {
        background-image: url('/asamiyoga/babyface-icon/babyface-icon-02.svg');
    }
    .questions.second:checked ~ .select-questions .second-questions {
        background-image: url('/asamiyoga/babyface-icon/babyface-icon-checked-02.svg');
    }
    .select-questions .third-questions {
        background-image: url('/asamiyoga/babyface-icon/babyface-icon-03.svg');
    }
    .questions.third:checked ~ .select-questions .third-questions {
        background-image: url('/asamiyoga/babyface-icon/babyface-icon-checked-03.svg');
    }
    .select-questions .four-questions {
        background-image: url('/asamiyoga/babyface-icon/babyface-icon-04.svg');
    }
    .questions.four:checked ~ .select-questions .four-questions {
        background-image: url('/asamiyoga/babyface-icon/babyface-icon-checked-04.svg');
    }
    .select-questions .five-questions {
        background-image: url('/asamiyoga/babyface-icon/babyface-icon-05.svg');
    }
    .questions.five:checked ~ .select-questions .five-questions {
        background-image: url('/asamiyoga/babyface-icon/babyface-icon-checked-05.svg');
    }
}
</style>
