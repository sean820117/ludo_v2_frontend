<template>
  <div :style="{visibility: is_ui_config_loaded ? 'visible':'hidden'} ">
    ...
    <titlebar :logo_src="is_ui_config_loaded ? ui_config.logo : ''" :project_name="is_ui_config_loaded ? ui_config.project_name : ''" :style="{ background : is_ui_config_loaded ? 'white' : '' , color : 'white' }">
        <div v-if="user.user_id != ''" slot="right-component" @click="$router.push('/logout')" :style="{ background : is_ui_config_loaded ? 'white' : '' , color : is_ui_config_loaded ? ui_config.base_color : '' }">登出</div>
        <div v-else slot="right-component" @click="$router.push('/resume/login')" :style="{ background : is_ui_config_loaded ? 'white' : '' , color : is_ui_config_loaded ? ui_config.base_color : '' }">登入</div>
    </titlebar>
    <nuxt/>
