export default {
    ...
    sub_course: [
        {
            ...
            placeholder:"假設你今天是一個"+ "社會科學學群" +"的申請生，請輸入一段簡短的自我介紹，目的是讓教授快速的認識你。(例如：我是林佳瑾，是一個關注心理健康的人，由於看見上百種不同的衝突都是源自於溝通不良，因此我期待能投入心理領域，在未來帶領大家從人心解決問題)",
        },
        {
            id:2,
            title:"有效的簡歷撰寫(共同必修)",
            ...
            link:"https://player.vimeo.com/video/319273700",
            assistant_id:"03db9c50-f211-11e8-93e5-7514b94dfe78",
            placeholder:"假設你今天是一個"+'社會科學學群'+"的申請生，請輸入你的經歷，以及嘗試簡短具體的介紹這段經歷。 (例如：我曾擔任班長，在開學短短7天內讓全班35人完成了420項老師的代辦工作)"
        },
        {
            id:3,
            title:"有感的申請動機(共同必修)",
        ...
        },
        {
            ...
            placeholder:"假設你今天是一個"+'社會科學學群'+"的申請生，以下請寫上你完整的申請動機內容。",
        },
        {
            id:6,
            title:"有效的自傳寫法(共同必修)",
        ...
        },
        {
            ...
            placeholder:"假設你今天是一個"+'社會科學學群'+"的申請生，以下請寫上你完整的自傳內容。",
        },
        {
            id:9,
            title:"不唬人的讀書計畫(共同必修)",
        ...
        },
        {
            ...
            placeholder:"假設你今天是一個"+'社會科學學群'+"的申請生，以下請寫上你完整的讀書計畫內容。",
        },
        {
            id:12,
            title:"最後重點強調(共同必修)",
    ...
    examples:[
        {  
            sub_course:"經歷",
            rank:"B",
            content:"高中時曾三度參與北醫社會科學營，並於每年寒暑假擔任台大醫院志工，從中更堅定了自己未來的志向，除了想習得專業知識技能外，也期許自己能成為一位宅心仁厚的助人者。"
        }
    ],
}