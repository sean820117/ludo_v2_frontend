<template>
    <div v-if="$mq === 'mobile'" style="height:100%">
        ...
        <div class="scrolldown">
            ...
            <div class="nine-block">
                ...
                <img src="/resume/Group 405.png" style="width:100%;height:auto;margin:auto;"/>
            </div>
            <div class="ten-block">
    ...
    <div v-else>
        ...
        <div class="md-first-block">
            ...
            <label class="md-seemore" for="checkseemore">
                瞭解更多
                <img src="/resume/Union 1.png"/>
            </label>
        </div>
        <div class="scrolldown">
            ...
            <div class="md-seven-block">
                ...
                <div class="md-videoplay">
                    <div id="md-share-mask"><div>點這分享到FB就能解鎖第二課</div></div>
                    <iframe id="md-demovideo" src="https://player.vimeo.com/video/319395957" frameborder="0" allow="autoplay; fullscreen" allowfullscreen width="500px" height="450px"></iframe>
                </div>
                <div id="md-democourses">
                    <div id="md-dc-1" class="md-course">
                        <div class="md-c-img"><img src="/resume/md-Group 54.png"/></div>
                        <div class="md-c-box">
                            <div class="md-c-title">超同標場</div>
                            <div class="md-c-context">以生在得算化山，種夠是種，看下優味？壓青能代東預上大！星方學，中格選不望能的公員東負前刻？</div>
                        </div>
                    </div>
                    <div id="md-dc-2" class="md-course">
                        <div class="md-c-img"><img src="/resume/md-Group 55.png"/></div>
                        <div class="md-c-box">
                            <div class="md-c-title">爭先基看媽多月</div>
                            <div class="md-c-context">常致來對，車長去設科勢地我度母物一和！存師了者，較自快日音行他給覺方主家目，以生在得算化山，種夠是種，看下優味？</div>
                        </div>
                    </div>
                </div>
                <div class="md-fbshare" id="md-fbshare">
                    <div class="md-clickshare" id="md-clickshare">點擊分享</div>
                    <div>分享到Facebook就能解鎖第二課</div>  
                </div>
            </div>
