<template>
    <div class="mirror">
        <!-- 開啟體驗魔境 -->
        <mamiyoga-old-practice-video-block @goBack="goBack()" 
        @closeResult="closeResult" :routine="routine"></mamiyoga-old-practice-video-block>
    </div>
</template>

<script>
import MamiyogaOldPracticeVideoBlock from '~/components/mamiyoga/MamiyogaOldPracticeVideoBlock.vue'
export default {
    data:()=>({
        routine_list:Array,
        routine:{},
