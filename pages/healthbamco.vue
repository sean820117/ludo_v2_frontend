<template>
    <div v-show="is_loaded" class="smartyoga-LP-container">
        <div :class="`smartyoga-LP-block smartyoga-LP-block${num}`" v-for=" num in max_block_num" :key="num">
            <img v-if="num - 1 != 3 || num - 1 != 10" class="main-img" :src="`${img_base_url}/${num-1}@2x.jpg`" alt="">
...
export default {
    data:()=>({
        img_base_url: "https://ludo-beta.s3-ap-southeast-1.amazonaws.com/static/healthbamco",
        img_colors:[
            "brown",
            "pink",
            "blue",
