<template>
    <div v-show="is_loaded" class="smartyoga-LP-container">
        <div :class="`smartyoga-LP-block smartyoga-LP-block${num}`" v-for=" num in max_block_num" :key="num">
            <img v-if="num % 2 == 1" class="main-img" :src="`${img_base_url}/LP1-${num}@2x.jpg`" alt="">
            <a href="/pay" v-else-if="num % 2 == 0" class="smartyoga-LP-block-with-btn" >
                <img class="main-img" :src="`${img_base_url}/LP1-buyblock@2x.jpg`" alt="">
...
export default {
    data:()=>({
        img_base_url: "https://ludo-beta.s3-ap-southeast-1.amazonaws.com/static/florame",
        img_colors:[
            "brown",
            "pink",
            "blue",
