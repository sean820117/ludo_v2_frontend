module.exports = {
    ...
    chapters: [
        ...
        },
        {
            ...
            video_id:'338559454',
            ai_id:'abstract',
            practice_hint:'參考格式：你好，我是OO設計系畢業的學生，產品設計是我的專長，除此之外我有不斷的在自我進修，對於UI/UX…',
            rank_comment: {
        ...
        },
        {
            ...
            practice_hint:'參考格式：OOOO活動企劃專員<br>一.協助發展、規劃、執行、改進行銷策略及計劃之工作<br><br>二.曾負責的專案…',
            rank_comment: {
        ...
        },
        {
            ...
            video_id:'338609851',
            ai_id:'volunteer',
            practice_hint:'參考格式：TQC-DK-專案管理概論-專業級PM3<br>管理過跨國行銷專案，完成過…',
            rank_comment: {
        ...
        },
        {
            ...
            practice_hint:'參考格式：高雄市政府社會局OOOO育兒資源中心服務志工<br>• 服務台接待與諮詢、協助看顧嬰幼兒活動安全、<br>•環境整理與…',
            rank_comment: {
